...
print_res(requests.get('http://localhost:55591/api/medications/1'))
print_res(requests.get('http://localhost:55591/api/medications/2'))
print_res(requests.get('http://localhost:55591/api/medications/3'))
